        ...
        <div class="row m-0 p-3 mb-5">
            ...
            @else
                <div class="col-s p-2 shadow">
                    <h1 class="fst-italic display-6 col-bg col-b-text p-3 m-0 text-center">{{__('ui.Nessun annuncio presente nella tua wishlist')}}</h1>
                </div>
                @endif
        ...
        @if ($my_wishlist->count() != 0)
            ...
            @else
                <div class="col-s p-2 shadow mb-5">
                    <h1 class="fst-italic display-6 m-0 col-bg col-b-text p-3 text-center">{{__('ui.Nessun annuncio presente nella tua wishlist')}}</h1>
                </div>
        @endif
            </div>
        </div>
