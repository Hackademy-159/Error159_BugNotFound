        ...
        <div class="row col-b">
            <div class="col-12 d-flex flex-column justify-content-center col-bg-text size-section">
                ...
                <div class="p-5">
                    ...
                    @else
                        <a class="cst-section-button py-3 px-4" href="{{ route('login') }}">{{__('ui.Diventa revisore')}}</a>
                    @endif
                </div>
                        ...
                        <div class="modal-content">
                            @if (Auth::check() && !Auth::user()->is_revisor)
                                <div class="modal-header col-bg">
                                    <h5 class="modal-title modal-title-text" id="staticBackdropLabel">{{__('ui.Conferma la tua scelta')}}
                                    </h5>
                                ...
                                <div class="modal-footer col-bg d-flex justify-content-center">
                                    ...
                                    <a href="{{ route('become.revisor') }}" class="cst-button width-custom">{{__('ui.Conferma')}}</a>
                                </div>
                            @else
                                <div class="modal-header col-bg">
                                    <h5 class="modal-title modal-title-text" id="staticBackdropLabel">{{__('ui.Attenzione')}}
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
